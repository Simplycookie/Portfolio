...
<html> 
    <head>
        ...
        <title>DICE Admin - Edit Booking</title>
    ...
    <body> 
        ...
        <a href="admin-manage-booking.php?eventcode=<?php echo $row['Event_ID'] ?>"><- Return</a>
            ...
            <form method="POST" enctype="multipart/form-data"> 
                ...
                <div class="admin-container">
                    ...
                    <select name="Event_ID" value="<?php echo $row["Event_ID"] ?>">
                        ...
                        <input type="submit" class="submitbtn" name="savebtn" value="Submit">
                </div>   
            </form> 
        </section>
