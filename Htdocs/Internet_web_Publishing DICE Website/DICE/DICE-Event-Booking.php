...
<head>
    ...
    <title>DICE - Event Booking</title>
...
<body>
    ...
    <main class="login-container">
        <form id="loginForm" method="POST" action="paymentform.php" target="_blank"></form>
        <div class="form-header">
            <h1>DICE Event Booking</h1>
            <p class="login-description">Here you can make your bookings with any of our available events.</p>
        </div>
        <div class="form-header">
            <h1>Personnal Information</h1>
            <p class="login-description" id="User_info"></p>
        </div>
        <div id="jsinputs">
        </div>
        <div class="form-header">
        ...
        <div class="form-group">
            ...
            <select name="Cat_ID" id="Cat_ID" oninput="booking()">
                <?php
        ...
        <div class="form-group">
            ...
            <select name="Event_ID" id="Event_ID" oninput="booking()">
            </select>
        ...
        <div class="form-group">
            ...
            <input type="number" id="Pax" name="Pax" placeholder="E.g. 1" required min="1" oninput="booking()">
            <div class="error-message" id="PaxError"></div>
        </div>

        <div class="form-header">
            <h1 id="booking" class="booking-deco">Booking Details</h1>
            <!-- Booking Details is hidden until pax is inputted -->
            <p class="login-description" id="details"></p>
        </div>
        <div id="secinput">
        </div>

        <div class="form-actions">
            <button type="submit" class="btn-submit" name="submit-btn" id="submit-btn" onclick="handleSubmit()">Proceed
                to payment</button>
        </div>
        </form>
        <div id="response"></div>
...
<script>
    ...
    function display_personnal() {
        ...
        if(fullname==""){
            alert("You must log in first before making any bookings");
    ...
    // makes the "Booking Details" visible
    function booking() {
