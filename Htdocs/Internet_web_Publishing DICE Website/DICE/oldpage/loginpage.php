...
<head>
    ...
    <!-- Font Awesome 6 (小眼睛图标) -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* ===== 登录卡片 – 严格遵循 Website Sign In.png ===== */
        ...
        .form-group input:focus {
            outline: none;
            border-color: #272727;
            box-shadow: 0 0 0 3px rgba(39, 39, 39, 0.1), inset 0 1px 4px rgba(0, 0, 0, 0.05);
        }
...
<body>
    <main class="login-container">
        ...
        <div class="login-description">
            Welcome to our D.I.C.E. Club website! Please sign in to manage your bookings, and explore exclusive events. If you don't have an account yet, sign up now !
