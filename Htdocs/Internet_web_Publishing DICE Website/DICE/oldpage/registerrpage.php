...
<body>
    ...
    <main class="registration-container">
        <div class="form-header">
            ...
            <p class="form-description">Join us and become one of our members of D.I.C.E!</p>
        </div>

        <form id="registrationForm" method="POST" action="Insert_user.php" target="_blank">
            <!-- 姓名 -->
            ...
            <div class="form-group">
                ...
                <div class="password-wrapper">
                    <input type="password" id="password" name="password" placeholder="8 alphanumerical characters" required pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" title="At least 8 characters with letters and numbers">
            ...
            <div class="radio-group">
                ...
                <label for="ageBelow">I am below the age of 18, and the consent form has been completed by my guardian</label>
            </div>
            ...
            <div class="form-actions">
                ...
                <p class="login-link">Already have an account? <a href="loginpage.html">Sign in here</a></p>
            </div>
