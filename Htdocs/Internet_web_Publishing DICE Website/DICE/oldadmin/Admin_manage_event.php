			...
			<table border="1" width="850px" class = "White_colour">
				...
				while($row = mysqli_fetch_assoc($result))
					...
					<tr class = "backAccent_colour_2 Accent_colour_1">
						...
						<td><a href="Admin_Event_edit.php?eventcode=<?php echo $row['Event_ID']; ?>">Edit</a></td>
						<td><a href="Admin_Booking_manage.php?eventcode=<?php echo $row['Event_ID']; ?>">View bookings</a></td>
				...
				?>
					<tr>
						<td colspan="7"><a href=Admin_Event_add.php>Add</a></td>
					</tr>
			</table>
	</body>
</html>
