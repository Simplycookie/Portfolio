...
<html> 
    ...
    <body> 
        ...
        <form method="POST" enctype="multipart/form-data"> 
            ...
            <textarea cols="100" name="Event_ActDes"></textarea><br>
        ...
        <?php
            if(isset($_POST["btn_submit"])){
                ...
                if($error == ""){
                    ...
                    "INSERT INTO dice_event (Event_Name, Event_Des, Event_Actdes, Event_Image, Event_Time, Event_Date) VALUE('$Name','$EDes','$EActDes','$Image','$ETime','$EDate')")){
