    ...
    <section class="box">
        ...
        <div class="boardgames-container">
            ...
            <div class="boardgame-card">
                <img class="boardgame-image" src="assets/nasi-lemak-board.webp" alt="Nasi Lemak Card Game">
                ...
                <div class="boardgame-content">
                    ...
                    <div class="boardgame-actions">
                        <a class="boardgame-action-button" href="DICE-Boardgame-List.php" target="_blank">View
                            Details
    ...
    <section>
        <a class="options-button" href="https://www.youtube.com/" target="_blank">
            <div>
                ...
                <br>
                <p>Interested in renting our board games? Click here!</p>
            </div>
        </a>
    </section>
